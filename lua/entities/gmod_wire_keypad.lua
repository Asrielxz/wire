...
if CLIENT then
    ...
    local W = 100
    local H = 200
    local KeyPos = {{X + 5, Y + 100, 25, 25, -2.2, 3.45, 1.3, 0}, {X + 37.5, Y + 100, 25, 25, -0.6, 1.85, 1.3, 0}, {X + 70, Y + 100, 25, 25, 1.0, 0.25, 1.3, 0}, {X + 5, Y + 132.5, 25, 25, -2.2, 3.45, 2.9, -1.6}, {X + 37.5, Y + 132.5, 25, 25, -0.6, 1.85, 2.9, -1.6}, {X + 70, Y + 132.5, 25, 25, 1.0, 0.25, 2.9, -1.6}, {X + 5, Y + 165, 25, 25, -2.2, 3.45, 4.55, -3.3}, {X + 37.5, Y + 165, 25, 25, -0.6, 1.85, 4.55, -3.3}, {X + 70, Y + 165, 25, 25, 1.0, 0.25, 4.55, -3.3}, {X + 5, Y + 67.5, 40, 25, -2.2, 4.25, -0.3, 1.6}, {X + 55, Y + 67.5, 40, 25, 0.3, 1.65, -0.3, 1.6}} -- 1 -- 2 -- 3 -- 4 -- 5 -- 6 -- 7 -- 8 -- 9 -- abort -- ok
    ...
    fontdata.size = 34
    surface.CreateFont("Trebuchet34", fontdata)
    fontdata.size = 24
    surface.CreateFont("Trebuchet24", fontdata)
