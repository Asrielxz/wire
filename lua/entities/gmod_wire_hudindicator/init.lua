...
function ENT:Think()
    ...
    if IsValid(self.Pod) then
        ...
        if ply ~= self.PodPly then
            -- Don't send umsg if player disconnected or is registered otherwise
...
duplicator.RegisterEntityClass("gmod_wire_hudindicator", WireLib.MakeWireEnt, "Data", "a", "ar", "ag", "ab", "aa", "b", "br", "bg", "bb", "ba", "material", "showinhud", "huddesc", "hudaddname", "hudshowvalue", "hudstyle", "allowhook", "fullcircleangle")